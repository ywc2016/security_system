...
<body>
	...
	<div id="toolbar" style="padding: 5px; height: auto;">
		...
		<sec:authorize ifAnyGranted="AUTH_UPLOAD_DOCUMENT">
			<a href="javascript:void(0)" onclick="uploadNewVersion();"
				class="easyui-linkbutton" iconCls="icon-upload" plain="true">上传新版本</a>
		</sec:authorize>
		<sec:authorize ifAnyGranted="AUTH_UPLOAD_DOCUMENT">
			<a href="javascript:void(0)" onclick="upload();"
				class="easyui-linkbutton" iconCls="icon-upload" plain="true">上传新的文档</a>
		</sec:authorize>
	</div>
	...
	<div id="mainQuery" class="easyui-dialog" title="查询" closed="true"
		...
		<form id="mainQuery-fm" method="post" novalidate>
			...
			<div class="fitem">
				<label>最近上传时间:</label> <input id="latestUploadTime"
			...
			<div class="fitem">
				<label>存在版本数:</label> <input id="existEditions"
					class="easyui-textbox" />
			</div>
		</form>
	</div>
	...
	<div id="dialog-uploadFile" class="easyui-dialog" title="上传文件"
		...
		<form id="upload-fm" method="post" novalidate>
			...
			<input id="upload_file_name_commaString"
				...
				name="upload_file_abstracts_commaString" type="hidden" /> <input
				id="versionId" name="versionId" type="hidden" />
		</form>
	</div>
	<div id="add-buttons">
		<div id="divStatus"
...
<script type="text/javascript" src="./js/document/documentVersion.js"></script>
