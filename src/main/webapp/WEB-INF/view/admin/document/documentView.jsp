...
<body>
	...
	<div id="toolbar" style="padding: 5px; height: auto;">
		<sec:authorize ifAnyGranted="AUTH_QUERY">
			<a href="javascript:void(0)" onclick="queryMain();"
				class="easyui-linkbutton" iconCls="icon-query" plain="true">查询</a>
		</sec:authorize>
		<sec:authorize ifAnyGranted="AUTH_UPLOAD_DOCUMENT">
			<a href="javascript:void(0)" onclick="upload();"
				class="easyui-linkbutton" iconCls="icon-upload" plain="true">上传</a>
		</sec:authorize>
		<sec:authorize ifAnyGranted="AUTH_DOWNLOAD_DOCUMENT">
			<a href="javascript:void(0)" onclick="downloadFile();"
				class="easyui-linkbutton" iconCls="icon-download" plain="true">下载</a>
		</sec:authorize>
		<sec:authorize ifAnyGranted="AUTH_DELETE_DOCUMENT">
			<a href="javascript:void(0)" onclick="deleteDocument();"
				class="easyui-linkbutton" iconCls="icon-delete" plain="true">删除</a>
		</sec:authorize>
		<sec:authorize ifAnyGranted="AUTH_SHARE_DOCUMENT">
			<a href="javascript:void(0)" class="easyui-splitbutton"
				menu="#shareMenu" iconCls="icon-share" plain="true">文档共享</a>
		</sec:authorize>
		<sec:authorize ifAnyGranted="AUTH_ENCRYOT_DOCUMENT">
			<a href="javascript:void(0)" onclick="encryptFile();"
				class="easyui-linkbutton" iconCls="icon-encryption" plain="true">文档加密</a>
		</sec:authorize>
		<sec:authorize ifAnyGranted="AUTH_DECRYPT_DOCUMENT">
			<a href="javascript:void(0)" onclick="decryptFile();"
				class="easyui-linkbutton" iconCls="icon-decrypt" plain="true">文档解密</a>
		</sec:authorize>
	</div>

	<div id="shareMenu" style="width: 150px;">
		<div iconCls="icon-share" onclick="shareDoc();">共享</div>
		<div iconCls="icon-cancel" onclick="cancelShareDoc();">取消共享</div>
	</div>
...
<script type="text/javascript" src="./js/document/documentView.js"></script>
<script type="text/javascript" src="./js/document/fileUpload.js"></script>
<script type="text/javascript" src="./js/document/encryptFile.js"></script>
<script type="text/javascript" src="./crypto-js-master/crypto-js.js"></script>
<script type="text/javascript" src="./js/util/encrypt.js"></script>
<script src="./SWFUploadv2.2.0.1Core/js/swfupload.js"
	type="text/javascript"></script>
<script src="./SWFUploadv2.2.0.1Core/js/swfupload.queue.js"
	type="text/javascript"></script>
<script src="./SWFUploadv2.2.0.1Core/js/fileprogress.js"
	type="text/javascript"></script>
<script src="./SWFUploadv2.2.0.1Core/js/handlers.js"
	type="text/javascript"></script>
