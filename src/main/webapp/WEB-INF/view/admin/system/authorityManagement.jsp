...
<body>
	<table id="main-table" class="easyui-datagrid" title="权限列表"
		data-options="
			url:'./admin/system/authority/findByExampleForPagination?${_csrf.parameterName}=${_csrf.token}',
			sortName:'name',
			singleSelect:true,
			toolbar:'#tb'">
		<thead>
			<tr>
				...
				<th data-options="field:'name',sortable:true,width:400">权限名</th>
	...
	<div id="query" class="easyui-dialog"
		...
		<form id="query-fm" method="post" novalidate>
			<div class="fitem">
				<label>权限名:</label> <input id="query-name" name="name" type="text"
	...
	<div id="show" class="easyui-dialog"
		...
		<form id="show-fm" method="post" novalidate>
			...
			<div class="fitem">
				<label>权限名:</label> <input id="show-name" name="name"
					class="easyui-validatebox easyui-textbox" disabled />
			</div>
			<div class="fitem">
				<label>备注:</label> <input id="show-description" name="description"
					disabled calss=" easyui-textbox" />
			</div>
			<div class="fitem">
	...
	<div id="add" class="easyui-dialog"
		...
		<form id="add-fm" method="post" novalidate>
			...
			<div class="fitem">
				<label>权限名:</label> <input id="add-name" name="name"
	...
	<div id="add-buttons">
		<a id="add-insert-save" href="javascript:void(0)"
			class="easyui-linkbutton" iconCls="icon-ok" onclick="addAuxiliary()">保存</a>
	</div>
	...
	<div id="edit" class="easyui-dialog"
		...
		<form id="edit-fm" method="post" novalidate>
			...
			<div class="fitem" id="edit-name-auxiliary">
				<label>权限名:</label> <input id="edit-name" name="name"
					class="easyui-validatebox easyui-textbox" required="true" />
			</div>
			<div class="fitem">
	...
	<div id="import-buttons">
		<a href="./excel/download-template/SysAuthority.xlsx"
	...
	<div id="role-authority" class="easyui-dialog" modal="true"
		...
		<table id="main-table-role-authority" class="easyui-datagrid">
			<thead>
				<tr>
					...
					<th data-options="field:'name',sortable:true,width:400">角色名称</th>
		...
		<div id="tb-role-authority-buttons">
			<a href="javascript:void(0)" class="easyui-linkbutton"
				iconCls="icon-edit" onclick="editAllRelevanceRoleAuxiliary();"
				plain="true">编辑</a> <a href="javascript:void(0)"
				class="easyui-linkbutton" iconCls="icon-save"
				onclick="saveAllRelevanceRoleAuxiliary();" plain="true">保存</a> <a
				href="javascript:void(0)" class="easyui-linkbutton"
				iconCls="icon-cancel" onclick="cancelAllRelevanceRoleAuxiliary();"
				plain="true">取消</a> <input name="name" id="role-authority-name">
			<a href="javascript:void(0)" class="easyui-linkbutton"
				iconCls="icon-search" onclick="queryAllRoleAuthorityMain();"
				plain="true">查询</a> <a href="javascript:void(0)"
				class="easyui-linkbutton" iconCls="icon-search"
				onclick="queryAllRoleAuthorityAll();" plain="true">显示全部</a>
		</div>
	</div>


	<!---- 关联权限与资源 ---->
	<div id="authority-resource" class="easyui-dialog" modal="true"
		data-options="maximized:true,closed:true,closable:true">
		<table id="main-table-authority-resource" class="easyui-datagrid">
			<thead>
				<tr>
					<th data-options="field:'ck',checkbox:true,hidden:true"></th>
					<th
						data-options="field:'id',sortable:true,width:50,align:'center',hidden:true">资源编号</th>
					<th
						data-options="field:'relevance',sortable:false,width:70,align:'center',formatter:function(value, row, index){
							if (value == 1) {return '是';}else{return '否';}},editor:{type:'checkbox',options:{on:'1',off:'0'}},
							styler:function(value,row,index){if (value == 1) {return 'color:green;';} else {return 'color:#888;';}}">关联</th>
					<th data-options="field:'name',sortable:true,width:400">资源名称</th>
					<th data-options="field:'description',sortable:true,width:400">备注</th>
					<th
						data-options="field:'relevanceId',sortable:true,width:100,align:'center',hidden:true">关联记录id</th>
				</tr>
		...
		<div id="tb-authority-resource-buttons">
			<a href="javascript:void(0)" class="easyui-linkbutton"
				iconCls="icon-edit" onclick="editAllRelevanceResourceAuxiliary();"
				plain="true">编辑</a> <a href="javascript:void(0)"
				class="easyui-linkbutton" iconCls="icon-save"
				onclick="saveAllRelevanceResourceAuxiliary();" plain="true">保存</a> <a
				href="javascript:void(0)" class="easyui-linkbutton"
				iconCls="icon-cancel"
				onclick="cancelAllRelevanceResourceAuxiliary();" plain="true">取消</a>
			<input name="name" id="authority-resource-name"> <a
				href="javascript:void(0)" class="easyui-linkbutton"
				iconCls="icon-search" onclick="queryAllAuthorityResourceMain();"
				plain="true">查询</a> <a href="javascript:void(0)"
				class="easyui-linkbutton" iconCls="icon-search"
				onclick="queryAllAuthorityResourceAll();" plain="true">显示全部</a>
		</div>
	</div>

	<!-- ------ --->
	<div id="authority-resource-all" class="easyui-dialog" modal="true"
		data-options="maximized:true,closed:true,closable:true">
		<table id="authority-resource-all-table" class="easyui-datagrid">
			<thead>
				<tr>
					<th data-options="field:'name',sortable:true,width:400">资源名称</th>
					<th data-options="field:'description',sortable:true,width:400">备注</th>
...
<script type="text/javascript" src="./js/system/authority.js"></script>
</html>